...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const presets = ["Custom", "E-Commerce", "B2B SaaS", "Media"];

  return (
    <aside className="w-72 shrink-0 bg-[#09090b] p-5 space-y-6 overflow-y-auto max-h-[calc(100vh-100px)] text-zinc-300 select-none">
      {/* Header */}
      <div className="flex items-center justify-between pb-1">
        <h2 className="text-xs font-semibold text-white flex items-center gap-2 font-mono uppercase tracking-wider">
      ...
      <div className="space-y-2">
        <label className="text-[11px] font-medium text-zinc-400 block">Execution Mode</label>
      ...
      {/* Presets */}
      <div className="space-y-2">
        <label className="text-[11px] font-medium text-zinc-400 block">Archetypes</label>
      ...
      <div className="space-y-3 pt-2">
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between text-[11px] font-mono">
            <span className="text-zinc-400">Target Power (1 - &beta;)</span>
        ...
        <div className="grid grid-cols-2 gap-2 text-xs font-mono pt-1">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full rounded-md bg-white/[0.04] px-2.5 py-1.5 text-white focus:bg-white/[0.08] focus:outline-none"
            />
          </div>
      ...
      <button
        ...
        className="w-full rounded-lg bg-blue-600 hover:bg-blue-500 text-white py-2.5 text-xs font-mono font-semibold tracking-tight flex items-center justify-center gap-2 shadow-sm transition-all active:scale-[0.98] disabled:opacity-50"
      >
        <Play className="h-3.5 w-3.5 fill-white" />
        <span>{isComputing ? "Computing..." : "Run Causal Analysis"}</span>
      </button>
    </aside>
  );
};
